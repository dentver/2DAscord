...
from utils.avatar import select_avatar, load_default_avatar
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.avatar_btn.clicked.connect(self.select_avatar_clicked)
        ...
        self.load_styles()
        load_default_avatar(self.avatar_label)
    ...
    def select_avatar_clicked(self) -> None:
        select_avatar(self, self.avatar_label)
